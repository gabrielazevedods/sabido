...
urlpatterns = [
    ...
    path('<int:id>/', views.kanban_todo_form, name = 'kanban_todo_update'),
    path('<int:id>/', views.kanban_doing_form, name = 'kanban_doing_update'),
    path('<int:id>/', views.kanban_done_form, name = 'kanban_done_update'),
