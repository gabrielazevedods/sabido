...
It04     |  29/06/2022 | 19/07/2022 |  19/07/2022  | [Gabriel G](https://github.com/gabrielgoncalo) | Revisao e atualizacao dos documentos: Documento de visao, Documento de Modelos, Documento Lista de User Stories, Documento de Projeto Arquitetural, Atualização do Plano de Iteração, Testar os User Stories, Consolidação dos Testes de Unidade, Execução dos Testes de Aceitação, Edição do Relatório de testes, Execução do SonarQube, Correção dos possíveis bugs, Consolidação dos testes de unidade, Implementação do login |
